...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--rgb_sample_path',
        type=str,
        default='kinetics_i3d_pytorch/data/kinetic-samples/v_CricketShot_g04_c01_rgb.npy',
    ...
    parser.add_argument(
        '--flow_sample_path',
        type=str,
        default='kinetics_i3d_pytorch/data/kinetic-samples/v_CricketShot_g04_c01_flow.npy',
        help='Path to kinetics flow numpy sample')

    parser.add_argument(
        '--classes_path',
        type=str,
        default='kinetics_i3d_pytorch/data/kinetic-samples/label_map.txt',
